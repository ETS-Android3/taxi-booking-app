        ...
        calllay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mobile_str == null || mobile_str.equalsIgnoreCase("")) {
                    ...
                    if (ActivityCompat.checkSelfPermission(DriverDetailAct.this, android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                        return;
                    }
            ...
            try {
                ...
                for (int k = 0; k < jsonArray1.length(); k++) {
                   ...
                   // car_detail_str= jsonObject2.getString("car_model") + "\n" + jsonObject2.getString("car_number").trim() + " , " + jsonObject2.getString("car_color");
                    car_detail_str= jsonObject2.getString("car_model") + "\n" + jsonObject2.getString("car_number").trim() + " , Amarillo";
                   ...
                   String driver_id = jsonObject2.getString("id");
                    cardetail.setText("" +car_detail_str);
