package main.com.jjtaxiuser.service;
...
import main.com.jjtaxiuser.activity.ChatingAct;
...
import static main.com.jjtaxiuser.utils.NotificationUtils.isAppIsInBackground;
...
//Booking request has been canceled by user
                ...
                if (keyMessage.equalsIgnoreCase("your booking request is Cancel")){
                    ...
                    msg=getResources().getString(R.string.yourbookaccept);
                }
