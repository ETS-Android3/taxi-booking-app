package main.com.jjtaxiuser.multipledroppoint;
            ...
            public void onMapLongClick(LatLng pointa) {
                ...
                if (clickstatus == 0) {
                    ...
                    if (isLocationOnPath) {
                        ...
                        clickstatus = 1;
                        MarkerOptions marker2 = new MarkerOptions().position(point).icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_marker_rojo)).flat(true).anchor(0.5f, 0.5f).snippet("pickup").visible(true);
