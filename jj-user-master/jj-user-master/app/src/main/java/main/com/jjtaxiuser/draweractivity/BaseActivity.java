...
public class BaseActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    boolean exit = false;
    MySession mySession;
    private LinearLayout add_card_lay,mywallet,ridehistory,logout,adddriver,myprofile,languagelay,callEmergenci,homelay, companyprofile;
    private TextView mywalletmoney, user_Pin;
            ...
            try {
                ...
                if (message.equalsIgnoreCase("1")) {
                    ...
                    if(!message1.equalsIgnoreCase("null")) {
                        userPinCode = jsonObject1.getString("pin");
                    }
                }
    ...
    private void idinit() {
        ...
        companyprofile = findViewById(R.id.companyprofile);
        user_Pin = findViewById(R.id.user_Pin);
        if (userPinCode != null ){
            user_Pin.setText(userPinCode);
